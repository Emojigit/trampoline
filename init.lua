...
minetest.register_node("trampoline:fall_dampener_50", {
...
minetest.register_node("trampoline:fall_dampener_100", {
...
minetest.register_craft({
	output = "trampoline:fall_dampener_50",
	recipe = {
		{ "", "", ""},
...
minetest.register_craft({
	output = "trampoline:fall_dampener_100",
	recipe = {
		{ "technic:raw_latex", "technic:raw_latex", "technic:raw_latex"},
		{ "technic:latex_foam", "technic:latex_foam", "technic:latex_foam"},
		{ "technic:latex_foam", "technic:latex_foam", "technic:latex_foam"},
